...
public class IncidentTicket {
    ...
    public static class Builder {
        ...
        public Builder withReporterEmail(String reporterEmail) {
            this.reporterEmail = reporterEmail;
            return this;
        }
        ...
        public Builder withAssigneeEmail(String assigneeEmail) {
            this.assigneeEmail = assigneeEmail;
            return this;
        }

        public Builder withCustomerVisible(boolean customerVisible) {
            this.customerVisible = customerVisible;
            return this;
        }

        public Builder withSlaMinutes(Integer slaMinutes) {
    ...
    private IncidentTicket(Builder b) {
        ...
        this.tags = List.copyOf(b.tags); // already a copy
    ...
    return new Builder()
            .withId(id)
            .withReporterEmail(reporterEmail)
            .withTitle(title)
            .withDescription(description)
            .withPriority(priority)
            .withTags(tags)
            .withAssigneeEmail(assigneeEmail)
            .withCustomerVisible(customerVisible)
            .withSlaMinutes(slaMinutes)
            .withSource(source);
    }
